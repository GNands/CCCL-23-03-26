...
export default function Sidebar() {
  ...
  return (
    <div className="fixed right-0 top-1/3 -translate-y-1/2 z-50 group">
      <div className="bg-white/90 dark:bg-blue-900/90 backdrop-blur-md border border-amber-500/40 border-r-0 rounded-l-2xl p-2 flex flex-col gap-2 translate-x-full group-hover:translate-x-0 transition-transform duration-300 relative shadow-[-10px_0_30px_rgba(245,158,11,0.15)]">
        {/* The visible tab when closed */}
        <div className="absolute -left-8 top-1/2 -translate-y-1/2 bg-white/90 dark:bg-blue-900/90 backdrop-blur-md border border-amber-500/40 border-r-0 rounded-l-lg w-8 h-16 flex items-center justify-center cursor-pointer group-hover:opacity-0 transition-opacity duration-300 shadow-[-5px_0_15px_rgba(245,158,11,0.15)]">
